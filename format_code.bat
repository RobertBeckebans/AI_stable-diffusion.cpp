...
astyle.exe -v --formatted --options=astyle-header.ini --exclude="ggml/src/ggml-impl.h" --recursive *.h
astyle.exe -v --formatted --options=astyle-cpp.ini --exclude="ggml/src/ggml-cpu/ggml-cpu.c" --recursive *.c
